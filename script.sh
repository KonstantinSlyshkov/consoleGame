#!/bin/bash
BUILD_NUMBER=$(curl -v -s -X POST https://circleci.com/api/v1.1/project/github/konstantinslyshkov/webApplication/tree/master?circle-token=79420eb9943f598fcc19f7b7becf408031d39ae0 | grep -m 2 -Po '\"build_num\" : \K[0-9]+' | tail -n 1 )
